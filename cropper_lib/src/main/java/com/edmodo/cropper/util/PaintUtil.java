...
public class PaintUtil {
    ...
    private static final String DEFAULT_CORNER_BORDER_COLOR = "#4D000000";
    private static final String SEMI_TRANSPARENT = "#CCCCCC";
    private static final String GUILDE_LINE = "#4D000000";
    ...
    public static Paint newGuidelinePaint() {
        ...
        paint.setColor(Color.parseColor(GUILDE_LINE));
    ...
    public static Paint newCornerPaint(Context context) {
        ...
        // Set the line thickness for the crop window border.
        final float lineThicknessPx = getCornerThickness(context);
    ...
    public static float getCornerThickness(Context context) {
    	return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                DEFAULT_CORNER_THICKNESS_DP,
                context.getResources().getDisplayMetrics());
    }
    
    public static Paint newCornerBorderPaint(Context context) {

        // Set the line thickness for the crop window border.
        final float lineThicknessPx = 2 + getCornerThickness(context);

        final Paint cornerBorderPaint = new Paint();
        cornerBorderPaint.setColor(Color.parseColor(DEFAULT_CORNER_BORDER_COLOR));
        cornerBorderPaint.setStrokeWidth(lineThicknessPx);
        cornerBorderPaint.setStyle(Paint.Style.STROKE);

        return cornerBorderPaint;
    }
