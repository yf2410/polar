...
public class CropOverlayView extends View {
    ...
    private Paint mCornerBorderPaint;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int px = Utils.dip2px(getContext(), 2);
        // Draws the main crop window border.
        canvas.drawRect(Edge.LEFT.getCoordinate() - px,
                        Edge.TOP.getCoordinate() - px,
                        Edge.RIGHT.getCoordinate() + px,
                        Edge.BOTTOM.getCoordinate() + px,
                        mBorderPaint);
    ...
    private void init(Context context) {
        ...
        mCornerBorderPaint = PaintUtil.newCornerBorderPaint(context);
    ...
    private void drawBackground(Canvas canvas, Rect bitmapRect) {
        ...
        int pxLeft = Utils.dip2px(getContext(), 3);
        int pxTop = Utils.dip2px(getContext(), 1);
        canvas.drawRect(bitmapRect.left, bitmapRect.top, bitmapRect.right, top - pxTop, mBackgroundPaint);
        canvas.drawRect(bitmapRect.left, bottom + pxTop, bitmapRect.right , bitmapRect.bottom, mBackgroundPaint);
        canvas.drawRect(bitmapRect.left, top - pxTop, left - pxLeft, bottom + pxTop, mBackgroundPaint);
        canvas.drawRect(right + pxLeft, top - pxTop, bitmapRect.right, bottom + pxTop, mBackgroundPaint);
    }
    ...
    private void drawCorners(Canvas canvas) {
        ...
        canvas.drawLine(left - mCornerOffset,
                ...
                top + mCornerLength + 1,
                mCornerBorderPaint);
        canvas.drawLine(left, top - mCornerOffset, left + mCornerLength + 1, top - mCornerOffset, mCornerBorderPaint);
        ...
        canvas.drawLine(right + mCornerOffset,
                ...
                top + mCornerLength + 1,
                mCornerBorderPaint);
        canvas.drawLine(right, top - mCornerOffset, right - mCornerLength - 1, top - mCornerOffset, mCornerBorderPaint);
        ...
        canvas.drawLine(left - mCornerOffset,
                ...
                left - mCornerOffset,
                bottom - mCornerLength - 1,
                mCornerBorderPaint);
        canvas.drawLine(left,
                bottom + mCornerOffset,
                left + mCornerLength + 1,
                bottom + mCornerOffset,
                mCornerBorderPaint);
