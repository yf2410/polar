package com.polar.browser.view.switchbutton;
...
import com.polar.browser.view.switchbutton.AnimationController.OnAnimateListener;
...
public class SwitchButton extends CompoundButton {
	...
	public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
		...
		mConf.setRadius(ta.getInt(R.styleable.SwitchButton_r, Configuration.Default.DEFAULT_RADIUS));
