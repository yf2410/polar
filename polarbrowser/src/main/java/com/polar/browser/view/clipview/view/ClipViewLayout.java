...
import com.polar.browser.view.clipview.gestures.GestureDetector;
import com.polar.browser.view.clipview.gestures.OnGestureListener;
import com.polar.browser.view.clipview.gestures.VersionedGestureDetector;
...
public class ClipViewLayout extends RelativeLayout implements OnGestureListener {
    ...
    //最大缩放比例
    private float maxScale = 3;   // value = maxScale/minScale
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (getScale() < minScale) {
                    ...
                    if (null != rect) {
                        startZoomInAnimation(getScale(),minScale,rect.centerX(),rect.centerY());
                    }
                }
                break;
