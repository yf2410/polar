...
//    public static final String ACTION_DOWNLOAD_CALLBACK = "com.polar.browser..download_refactor.DOWNLOAD_CALLBACK";
    ...
    public static final String PROVIDER_PACKAGE_NAME = "com.polar.browser.android.provider.DownloadProvider";
...
//    public static final String DEFAULT_DL_SUBDIR = "/" + Environment.DIRECTORY_DOWNLOADS;
    ...
    public static final int MAX_DOWNLOAD_TASK_COUNT = 3;

    public static final int DEFAULT_THREAD_THRESHOLD = 500 * 1024; // 500KB
     ...
     * a Retry-After response header with a parameter in delta-seconds.
     */
    public static final int MAX_RETRY_AFTER = 60; // 60min
    ...
    public static final boolean LOGV = LOCAL_LOGV;

    /** 调试附加日志开关 */
    private static final boolean LOCAL_LOGVV = false;
    public static final boolean LOGVV = LOCAL_LOGVV;

    public static final String TYPE_IMAGE = "image";
    public static final String TYPE_AUDIO = "audio";
    public static final String TYPE_VIDEO = "video";
    public static final String  TYPE_APK = "apk";
    public static final String TYPE_ZIP = "zip_file";
    public static final String TYPE_DECOMPRESS = "decompress_file";//已解压的file
    public static final String TYPE_DOC = "doc";
    public static final String TYPE_WEB_PAGE = "web_page";
    public static final String TYPE_OTHER = "other";
    public static final String TYPE_ALL = "all";//所有类型 。
}
